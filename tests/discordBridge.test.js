...
test('Las actualizaciones de "typing" en Discord actualizan la presencia en WhatsApp', async () => {
...
test('El modo oneWay bloquea el reenvío de WhatsApp -> Discord en discordHandler', async () => {
  const originalDiscordUtils = {
    getGuild: utils.discord.getGuild,
    getControlChannel: utils.discord.getControlChannel,
...
test('El sufijo de plataforma del remitente en WhatsApp se añade a los mensajes replicados en Discord', async () => {
  const originalDiscordUtils = {
    getGuild: utils.discord.getGuild,
    getControlChannel: utils.discord.getControlChannel,
    getOrCreateChannel: utils.discord.getOrCreateChannel,
...
test('messageDelete en Discord emite discordDelete para mensajes puenteados', async () => {
  const originalDiscordUtils = {
    getGuild: utils.discord.getGuild,
    getControlChannel: utils.discord.getControlChannel,
    channelIdToJid: utils.discord.channelIdToJid,
...
test('Los mensajes del sistema de fijado (pin) en Discord no se reenvían a WhatsApp', async () => {
  const originalDiscordUtils = {
    getGuild: utils.discord.getGuild,
    getControlChannel: utils.discord.getControlChannel,
    channelIdToJid: utils.discord.channelIdToJid,
...
test('Los mensajes del bot en Discord pueden bloquearse para que no se reenvíen a WhatsApp', async () => {
  const originalDiscordUtils = {
    getGuild: utils.discord.getGuild,
    getControlChannel: utils.discord.getControlChannel,
    channelIdToJid: utils.discord.channelIdToJid,
...
test('Las eliminaciones de bots no puenteados no generan errores cuando redirectBots está deshabilitado', async () => {
  const originalDiscordUtils = {
    getGuild: utils.discord.getGuild,
    getControlChannel: utils.discord.getControlChannel,
    channelIdToJid: utils.discord.channelIdToJid,
...
test('messageUpdate en Discord emite discordEdit para mensajes puenteados', async () => {
  const originalDiscordUtils = {
    getGuild: utils.discord.getGuild,
    getControlChannel: utils.discord.getControlChannel,
    channelIdToJid: utils.discord.channelIdToJid,
...
test('Los cambios de pin en Discord se sincronizan con WhatsApp mediante waClient.sendMessage', async () => {
  const originalSetTimeout = global.setTimeout;
  const originalDiscordUtils = {
    getGuild: utils.discord.getGuild,
    getControlChannel: utils.discord.getControlChannel,
...
test('Las reacciones en Discord emiten discordReaction hacia WhatsApp', async () => {
  const originalDiscordUtils = {
    getGuild: utils.discord.getGuild,
    getControlChannel: utils.discord.getControlChannel,
    channelIdToJid: utils.discord.channelIdToJid,
